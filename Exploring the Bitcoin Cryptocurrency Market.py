...
ax = cap10.market_cap_usd.plot.bar(title=TOP_CAP_TITLE,color=COLORS,logy=True)
...
biggish = 'market_cap_usd>10000000000'

# Same as above for micro ...
micro = 'market_cap_usd <=300000000 & market_cap_usd>=50000000'

# ... and for nano
nano =  'market_cap_usd<50000000'

# Making a list with the 3 counts
values = [capcount(biggish),capcount(micro),capcount(nano)]
